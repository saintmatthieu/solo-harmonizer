...
double SoloHarmonizerProcessor::getTailLengthSeconds() const
{
    return 0.0;
}
...
int SoloHarmonizerProcessor::getCurrentProgram()
{
    return 0;
}
...
void SoloHarmonizerProcessor::changeProgramName (int index, const juce::String& newName)
{
    juce::ignoreUnused (index, newName);
}

//==============================================================================
void SoloHarmonizerProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
bool SoloHarmonizerProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void SoloHarmonizerProcessor::setStateInformation (const void* data, int sizeInBytes)
{
